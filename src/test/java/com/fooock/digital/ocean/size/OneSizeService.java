 ...
 *
 */
public class OneSizeService implements SizeService {

    private final BehaviorDelegate<SizeService> behaviorDelegate;
    private final ReadResources readResources = new ReadResources();

    OneSizeService(BehaviorDelegate<SizeService> behaviorDelegate) {
        this.behaviorDelegate = behaviorDelegate;
    }

    @Override
    public Call<SizeResponse> all() throws ApiException {
        final String content = readResources.loadJson("src/test/resources/sizes/one_size.json");
