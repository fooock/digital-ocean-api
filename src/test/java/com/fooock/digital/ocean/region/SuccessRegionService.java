 ...
 *
 */
public class SuccessRegionService implements RegionService {

    private final BehaviorDelegate<RegionService> behaviorDelegate;
    private final ReadResources readResources = new ReadResources();

    SuccessRegionService(BehaviorDelegate<RegionService> behaviorDelegate) {
    ...
    public Call<RegionsResponse> all() throws ApiException {
        final String content = readResources.loadJson("src/test/resources/regions/regions.json");
