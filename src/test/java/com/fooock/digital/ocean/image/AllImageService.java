 ...
 *
 */
public class AllImageService implements ImageService {

    private final BehaviorDelegate<ImageService> behaviorDelegate;
    private final ReadResources readResources = new ReadResources();

    AllImageService(BehaviorDelegate<ImageService> behaviorDelegate) {
        this.behaviorDelegate = behaviorDelegate;
    }

    @Override
    public Call<ImagesResponse> all() throws ApiException {
        final String content = readResources.loadJson("src/test/resources/images/all_images.json");
